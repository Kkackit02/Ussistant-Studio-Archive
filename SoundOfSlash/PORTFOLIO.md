...
| 버전 | 날짜 | 담당 | 내용 |
|------|------|------|------|
| v0.1.1 | 2024-06-13 | 근녕 | AUTO Mode 빌드 |
| v0.1.2 | 2024-06-16 | 근녕 | 미션 기능 · Retry · Credit 씬 · 효과음 추가 |
| v0.1.5 | 2024-06-20 | 근녕 | Horror 배경 적용 |
| v0.1.6 | 2024-06-24 | 근녕 | 버그 수정 |
| v0.1.7 | 2024-06-26 | 근녕 | 로비 키보드 조작 · BG/NOTE 선택 저장 |
| v0.1.8 | 2024-07-02 | 근녕 | Setting UI (BGM/SFX) · Key 설정 추가 |
| v0.1.9 | 2024-07-08 | 근녕 | Calibration · Key Setting · Easy 모드 3곡 |
| v0.1.10 | 2024-07-13 | 근녕 | Ghost FX 버그 수정 · ToyLand BG · 이전 곡 기억 |
| v0.1.12 | 2024-07-19 | 근녕 | Offset 적용 · 콤보골렘 모션 수정 |
| v0.1.13 | 2024-07-21 | 근녕 | (에디터 offset 단위 불일치 임시 빌드) |
| v0.1.14 | 2024-07-22 | 근녕 | Key binding 초기값 · 키 설정창 개선 |
| v0.1.18 | 2024-08-02 | 근녕 | Offset 적용 방식 전면 개선 · Note Line offset |
| v0.1.19 | 2024-08-07 | 근녕 | 새 곡 추가 (HEAVYgiant 시리즈) |
| v0.1.20 | 2024-08-07 | 근녕 | 콤보 애니메이션 개선 · 배속 0.5 단위 |
| v0.1.21 | 2024-08-09 | 근녕 | 새 곡 추가 (BraveHeart 등) · anim 버그 수정 |
| v0.1.22 | 2024-08-09 | 근녕 | 콤보 애니메이션 버그 수정 |
| v0.1.23 | 2024-08-10 | 근녕 | 콤보 애니메이션 안정화 |
| v0.1.24 | 2024-08-11 | 근녕 | 스킨 선택 기능 구현 |
| v0.1.28 | 2024-08-15 | 근녕 | SFX 최신 파일 교체 |
| v0.1.31 | 2024-08-19 | 근녕 | Menu Tab UX 변경 · 피버 활성 조건 개편 · 4key 곡 추가 |
| v0.1.32 | 2024-08-22 | 근녕 | 콤보골렘 애니메이션 버그 수정 **(BIC 전시 빌드)** |
| v0.2.0 | 2024-09-02 | 근녕 | ⭐ **Steam Early Access 정식 출시** |
| v0.2.1 | 2024-09-07 | 근녕 | 출시 후 핫픽스 |
| v0.2.6 | 2024-09-29 | 근녕 | HP Bar 레이어 · 배속 버그 수정 · 곡 추가 |
| v0.3.0 | 2024-10-14 | 근녕 | Hold · Rolling · Long Range 노트 · 에디터 JSON 호환 |
| v0.3.4 | 2024-10-22 | 근녕 | Horror FX · 누락 곡 추가 · 전 콘텐츠 해금 **(CBF 전시)** |
| v0.3.7 | 2024-11-10 | 근녕 | MusicSelection 이미지 개선 |
| v0.3.11 | 2025-01-04 | 근녕 | Long Range Note 연동 · Profile 배경/스킨/노트 선택 |
| v0.3.12 | 2025-02-04 | 휘민 | new_Profile 완성 · 폰트 변경 · 캐릭터 애니메이션 |
| v0.3.13 | 2025-02-15 | 근녕+휘민 | ms 기반 판정 전환 · 노트 이미지 수정 · UI 버그 수정 |
| v0.3.14 | 2025-03-01 | 근녕 | 콤보 UI 개편 · 피버 배수 결과 표시 |
| v0.3.16 | 2025-03-09 | 휘민 | 연타 노트 패치 · Output 파일 정리 |
| v0.3.17 | 2025-03-15 | 근녕 | 점수 시스템 수정 · 타격 이펙트 · Chain 이미지 버그 수정 |
| v0.3.18 | 2025-03-17 | 휘민 | 정확도 수치 조정 · 애니메이션 자연스럽게 |
| v0.3.19 | 2025-03-19 | 근녕 | JSON 버그 수정 · 전 곡 정상 로드 |
| v0.3.20 | 2025-03-24 | 휘민 | Calibration 수정 · 전 곡 앨범아트 추가 |
| v0.3.21 | 2025-04-03 | 휘민 | 튜토리얼 완성 · Profile Click Sound |
| v0.3.22 | 2025-04-14 | 휘민 | 튜토리얼 버그 수정 · Hold 노트 버그 수정 |
| v0.3.23 | 2025-05-05 | 근녕 | 안정화 · Tutorial 스킵/Task 시스템 추가 |
| v0.3.27 | 2025-10-18 | 휘민 | 상점 · 배틀패스 첫 적용 |
| v0.3.31 | 2025-11-10 | 휘민 | 일반 노트 몬스터 변환 버그 수정 · Hold 체인 길이 버그 수정 |
| v0.3.33 | 2025-11-13 | 휘민 | Slider Handle 개선 · Breath Effect |
| v0.3.34 | 2025-11-25 | 휘민 | 박쥐 텍스처 변경 · Missile/포물선 노트 스킨 변경 · 속도 고정 |
| v0.3.35 | 2025-12-05 | 휘민 | 콤보 몬스터 Idle 애니메이션 · Missile 속도 = 일반 × 2 |
| v0.3.36 | 2026-01-05 | 휘민 | 2P 모드 추가 · 포물선 노트 개선 · 배틀패스 |

#### 에디터 (v0.1~v0.3: 민규 담당 / v0.4~: 근녕 인수)

| 버전 | 날짜 | 담당 | 내용 |
|------|------|------|------|
| v0.1.3 | 2024-06-30 | 민규 | 배속 그리드 반영 · 단축키 (50%) |
| v0.1.4 | 2024-07-03 | 민규 | Offset 음수 반영 |
| v0.1.11 | 2024-07-20 | 민규 | BPM 값 JSON 오류 재수정 |
| v0.2.4 | 2024-08-06 | 민규 | 노트 이동속도 BPM 연동 오류 수정 |
| v0.2.8 | 2024-08-09 | 민규 | 그리드 이동속도 수정 · BPM 수정 UI |
| v0.2.13 | 2024-08-28 | 민규 | 이전 노래 데이터 추가 |
| v0.2.14 | 2024-09-07 | 민규 | 곡 15곡 추가 |
| v0.2.15 | 2024-09-08 | 민규 | MultiSelection 범위 선택 · Delete 기능 |
| v0.2.16 | 2024-09-11 | 민규 | 노래 파일 불러오기 구조 개선 |
| v0.2.17 | 2024-09-16 | 민규 | 비트맵 복제 추가 |
| v0.3.1 | 2024-10-13 | 민규 | M2(원거리) · M3(난타) 노트 추가 |
| v0.3.2 | 2024-10-21 | 민규 | 신규 노트 타 비트맵 영향 버그 수정 |
| v0.3.3 | 2024-10-28 | 민규 | 연타 노트 JSON 오류 수정 |
| v0.3.5 | 2024-11-21 | 민규 | 난타 노트 오류 수정 |
| **v0.4.0** | **2025-02-01** | **근녕** | **전체 리팩토링 · BPM/OFFSET 소수점 · Grid 엔진 재설계** |
| v0.4.1 | 2025-02-01 | 근녕 | 에디터 아이콘 · 사운드 버그 수정 · Holding/BackToBack JSON 연동 |
| v0.4.3 | 2025-03-10 | 휘민 | 전 곡 Output 파일 교체 |
| v0.4.4 | 2025-03-20 | 근녕 | 튜토리얼 곡 적용 |
| v0.4.5 | 2025-04-14 | 근녕 | BeatSnap Divisor 버그 수정 · BPM 변경 JSON 반영 · combo 노트 수정 |
| v0.4.7 | 2025-10-21 | 근녕 | Missile Note 추가 |

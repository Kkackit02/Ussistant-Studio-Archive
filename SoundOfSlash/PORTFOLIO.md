...
| 버전 | 날짜 | 주요 내용 |
|------|------|-----------|
| v0.1.1 | 2024-06-13 | AUTO Mode · 미션 · Retry · Credit 씬 |
...
| v0.1.31 | 2024-08-19 | Menu Tab UX 개편 · 피버 활성 조건 개편 |
| **v0.1.32** | **2024-08-21** | **⭐ BIC 전시 최종 빌드** |
| **v0.2.0** | **2024-09-02** | **⭐ Steam Early Access 정식 출시** |
| **v0.3.0** | **2024-10-14** | **Hold · Rolling · Long Range 노트 추가 · 에디터 JSON 호환** |
| v0.3.4 | 2024-10-22 | ⭐ CBF 전시 빌드 · Horror FX |
| v0.3.11 | 2025-01-04 | Long Range 연동 · Profile 배경/스킨 선택 |
...
| v0.1.7 | 2024-06-26 | 로비 키보드 조작 · BG/NOTE 선택 저장 |
| v0.1.8 | 2024-07-02 | Setting UI (BGM/SFX) · Key 설정 |
| v0.1.9 | 2024-07-08 | Calibration · Key Setting · Easy 모드 곡 3곡 |
| v0.1.10 | 2024-07-13 | Ghost FX 버그 수정 · ToyLand BG 속도 조정 · 이전 곡 기억 |
| v0.1.12 | 2024-07-19 | Offset 적용 · 콤보골렘 모션 수정 |
| v0.1.13 | 2024-07-21 | 빌드 (에디터 offset 단위 불일치 임시 빌드) |
| v0.1.14 | 2024-07-22 | Key binding 초기값 · 키 설정창 개선 · 로비 설정 |
| v0.1.18 | 2024-08-02 | Offset 적용 방식 변경 · Note Line offset 적용 · BG 이동 속도 수정 |
| v0.1.19 | 2024-08-07 | 새 곡 추가 (HEAVYgiant 시리즈) |
| v0.1.20 | 2024-08-07 | 콤보 애니메이션 개선 · 배속 0.5 단위 설정 |
| v0.1.21 | 2024-08-09 | 새 곡 추가 (BraveHeart 등) · anim 심각 버그 수정 |
| v0.1.22 | 2024-08-09 | 콤보 애니메이션 버그 수정 |
| v0.1.23 | 2024-08-10 | 콤보 애니메이션 안정화 |
| v0.1.24 | 2024-08-11 | 스킨 선택 기능 구현 (숫자 버튼) |
| v0.1.28 | 2024-08-15 | SFX 최신 파일 교체 |
| v0.1.31 | 2024-08-19 | Menu Tab UX 변경 · 피버 활성 조건 개편 · 4key 곡 추가 |
| v0.1.32 | 2024-08-21 | 콤보골렘 애니메이션 버그 수정 (BIC 전시 빌드) |
| v0.2.0 | 2024-09-02 | ⭐ **Steam Early Access 정식 출시** |
| v0.2.1 | 2024-09-07 | 출시 후 핫픽스 |
| v0.2.6 | 2024-09-29 | HP Bar 레이어 수정 · 배속 버그 수정 · 곡 추가 |
| v0.3.0 | 2024-10-14 | Hold · Rolling · Long Range 노트 · 새 에디터 JSON 호환 |
| v0.3.4 | 2024-10-22 | Horror FX · 누락 곡 추가 · 콘텐츠 자동 해금 (CBF 전시) |
...
| 버전 | 날짜 | 내용 |
|------|------|------|
| v0.4.0 | 2025-02-01 | 전체 리팩토링 · BPM/OFFSET 소수점 입력 · Grid 엔진 재설계 |
| v0.4.1 | 2025-02-01 | 에디터 아이콘 변경 · 사운드 버그 수정 · Holding/BackToBack JSON 연동 |

...
|---|---|---|
| **노트 타입** | Normal(기본) · 특수 5종 | Combo(Golem) · Hold(드래곤) · BackToBack(박쥐) · Long Range(EvilWood) · Missile(부엉이) — 특수 노트마다 몬스터 캐릭터 연출 |
...
> **노트 타입 체계**: Normal은 몬스터 없이 노트만 등장. 특수 노트(Combo · Hold · BackToBack · Long Range · Missile)는 각각의 몬스터 캐릭터가 함께 등장하며 처치 연출이 재생됩니다.

| 노트 타입 | 도입 | 몬스터 | 입력 방식 |
|-----------|------|--------|-----------|
| **Combo** | 출시 초기 | Combo Golem | 양쪽에서 동시에 노트 등장 |
| **Hold Note** | 2024-09 | 드래곤 | 키 유지 · 홀드 길이를 채보 `length` 필드로 관리 |
| **BackToBack Note** | 2024-10 | 박쥐 | 연속 입력 · 타이밍 누적 판정 |
| **Long Range Note** (EvilWood) | 2024-10 | EvilWood | 좌우에서 EvilWood 캐릭터가 등장해 포물선 노트 발사 |
| **Missile Note** | 2025-10 | 부엉이 | 부엉이 몬스터가 등장해 플레이어를 향해 노트 발사 |
...
| **v0.3.0** | **2024-10-14** | **Hold · BackToBack · Long Range(EvilWood) 노트 · 에디터 JSON 호환** |
...
| v0.3.0 | 2024-10-14 | Hold · BackToBack · Long Range 노트 · 에디터 JSON 호환 |
...
| 2024-09~10 | Hold · BackToBack · LongRange 노트 설계·구현 |

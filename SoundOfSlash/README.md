...
| 시기 | 내가 해결한 문제 |
|------|----------------|
| 2023 | 리듬게임 오디오-애니메이션 동기화 기초 설계 |
| 2024 | X좌표 판정 → DSP-time ms 판정으로 정밀도 향상 |
| 2025 | 클라이언트 의존 구조의 한계 인식 → Firebase 백엔드 이전 주도 |
| 2026 | 데이터 파이프라인 자동화 · 글로벌 리더보드 · Discord 어드민 봇 완성 |

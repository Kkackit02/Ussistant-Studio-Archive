...
| 참여 기간 | 총 커밋 | 구현 기능 | 해결 버그 |
|:---------:|:-------:|:---------:|:---------:|
| 2024.04 – 2026.04 | **587커밋** | **61개** | **12건** |

**역할:** 인게임 클라이언트 개발 · Firebase 백엔드 연동

**Tech Stack:** Unity C# · Firebase (Firestore / Cloud Functions) · Steamworks.NET · Node.js (TypeScript)

→ **[포트폴리오 상세 보기 (기술 구현 · 버그 해결 · 개발 흐름)](./PORTFOLIO.md)**
...
|------|-----------|------|
| **Normal** | 단타 | 기본 노트 |
| **Monster** | 단타 | 적 캐릭터로 등장, 처치 연출 |
| **Hold** | 키 유지 | 홀드 길이를 채보 `length` 필드로 관리 |
| **BackToBack** | 연속 입력 | 타이밍 누적 판정 |
| **Long Range** (EvilWood) | 포물선 노트 | 좌우에서 EvilWood 캐릭터가 등장해 포물선 노트 발사 · 프로젝트 내 명칭 혼용 |
| **Missile** | 발사체 노트 | 부엉이 몬스터가 화면에 나타나 플레이어를 향해 노트 발사 |
